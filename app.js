...
function guardarConfiguracion() {
    try {
        ...
        localStorage.setItem('bakeryCalculatorItemsExtra', JSON.stringify(itemsExtra)); // <-- AGREGAR
...
function cargarConfiguracion() {
    try {
        ...
        const savedItemsExtra = localStorage.getItem('bakeryCalculatorItemsExtra'); // <-- AGREGAR
        ...
        if (savedItemsExtra) { // <-- AGREGAR
            itemsExtra = JSON.parse(savedItemsExtra);
        }
        if (savedHistory) {
